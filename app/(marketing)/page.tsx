...
const MarketingPage = () => {
    return (
        <div className="flex items-center justify-center flex-col">
            ...
            bg-yellow-100 text-orange-600 rounded-full uppercase">
                ...
                <div className="text-3xl md:text-6xl bg-gradient-to-r from-green-600 to-green-500 text-white px-4 py-2 rounded-lg">
    Simplify Your Life
</div>
            </div>
